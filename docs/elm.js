	...
	function (lst, elem, offset) {
		...
		while (true) {
			...
			if (_p3.ctor === '[]') {
				...
				if (_elm_lang$core$Native_Utils.eq(_p3._0, elem)) {
...
var _user$project$Model$checkPiecesMatch = F3(
	function (_p2, _p1, _p0) {
		...
		var _p6 = _p4._1;
		var _p5 = _p0;
		return (_elm_lang$core$Native_Utils.eq(_p3._0, _p8) && _elm_lang$core$Native_Utils.eq(_p8, _p5._0)) || ((_elm_lang$core$Native_Utils.eq(_p3._1, _p6) && _elm_lang$core$Native_Utils.eq(_p6, _p5._1)) || (_elm_lang$core$Native_Utils.eq(_p3._2, _p7) && _elm_lang$core$Native_Utils.eq(_p7, _p5._2)));
	});
var _user$project$Model$setSpace = F3(
	function (spaceId, space, floor) {
		var _p9 = spaceId;
		switch (_p9.ctor) {
			case 'ZeroZero':
				return _elm_lang$core$Native_Utils.update(
...
var _user$project$Model$getSpace = F2(
	function (spaceId, floor) {
		var _p10 = spaceId;
		switch (_p10.ctor) {
			case 'ZeroZero':
				return floor.zeroZero;
			case 'OneZero':
				return floor.oneZero;
			case 'TwoZero':
				return floor.twoZero;
			case 'ZeroOne':
				return floor.zeroOne;
			case 'OneOne':
				return floor.oneOne;
			case 'TwoOne':
				return floor.twoOne;
			case 'ZeroTwo':
				return floor.zeroTwo;
			case 'OneTwo':
				return floor.oneTwo;
			default:
				return floor.twoTwo;
...
var _user$project$Model$getFloor = F2(
	function (floorId, board) {
		var _p11 = floorId;
		switch (_p11.ctor) {
			case 'Top':
				return board.top;
...
var _user$project$Model$setFloor = F3(
	function (floorId, newFloor, board) {
		var _p12 = floorId;
		switch (_p12.ctor) {
			case 'Top':
				return _elm_lang$core$Native_Utils.update(
...
var _user$project$Model$getRemainingPieces = _robertjlooby$elm_generic_dict$GenericDict$keys;
var _user$project$Model$removeFromRack = _robertjlooby$elm_generic_dict$GenericDict$remove;
var _user$project$Model$isInRack = _robertjlooby$elm_generic_dict$GenericDict$member;
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {mdl: a, board: b, selected: c, rack: d, turnState: e};
	});
var _user$project$Model$Board = F3(
	function (a, b, c) {
		return {top: a, middle: b, bottom: c};
	});
var _user$project$Model$Floor = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {zeroZero: a, zeroOne: b, zeroTwo: c, oneZero: d, oneOne: e, oneTwo: f, twoZero: g, twoOne: h, twoTwo: i};
	});
var _user$project$Model$PlayPiece = {ctor: 'PlayPiece'};
var _user$project$Model$SelectPiece = {ctor: 'SelectPiece'};
var _user$project$Model$Loss = {ctor: 'Loss'};
var _user$project$Model$Win = {ctor: 'Win'};
var _user$project$Model$Bottom = {ctor: 'Bottom'};
var _user$project$Model$Middle = {ctor: 'Middle'};
var _user$project$Model$Top = {ctor: 'Top'};
var _user$project$Model$OccupiedSpace = function (a) {
	return {ctor: 'OccupiedSpace', _0: a};
};
var _user$project$Model$place = F4(
	function (piece, floorId, spaceId, board) {
		var newFloor = A3(
			_user$project$Model$setSpace,
			spaceId,
			_user$project$Model$OccupiedSpace(piece),
			A2(_user$project$Model$getFloor, floorId, board));
		return A3(_user$project$Model$setFloor, floorId, newFloor, board);
	});
var _user$project$Model$EmptySpace = {ctor: 'EmptySpace'};
var _user$project$Model$emptyFloor = A9(_user$project$Model$Floor, _user$project$Model$EmptySpace, _user$project$Model$EmptySpace, _user$project$Model$EmptySpace, _user$project$Model$EmptySpace, _user$project$Model$EmptySpace, _user$project$Model$EmptySpace, _user$project$Model$EmptySpace, _user$project$Model$EmptySpace, _user$project$Model$EmptySpace);
var _user$project$Model$emptyBoard = A3(_user$project$Model$Board, _user$project$Model$emptyFloor, _user$project$Model$emptyFloor, _user$project$Model$emptyFloor);
...
var _user$project$Model$spaceIdPossibilities = _elm_lang$core$Native_List.fromArray(
...
var _user$project$Model$Piece = F3(
	function (a, b, c) {
		return {ctor: 'Piece', _0: a, _1: b, _2: c};
	});
var _user$project$Model$Square = {ctor: 'Square'};
var _user$project$Model$Triangle = {ctor: 'Triangle'};
var _user$project$Model$Circle = {ctor: 'Circle'};
var _user$project$Model$shapePossibilities = _elm_lang$core$Native_List.fromArray(
	[_user$project$Model$Circle, _user$project$Model$Triangle, _user$project$Model$Square]);
var _user$project$Model$Blue = {ctor: 'Blue'};
var _user$project$Model$Green = {ctor: 'Green'};
var _user$project$Model$Red = {ctor: 'Red'};
var _user$project$Model$colourPossibilities = _elm_lang$core$Native_List.fromArray(
	[_user$project$Model$Red, _user$project$Model$Green, _user$project$Model$Blue]);
var _user$project$Model$Gradient = {ctor: 'Gradient'};
var _user$project$Model$StrokeOnly = {ctor: 'StrokeOnly'};
var _user$project$Model$Full = {ctor: 'Full'};
var _user$project$Model$patternPossibilities = _elm_lang$core$Native_List.fromArray(
	[_user$project$Model$Full, _user$project$Model$StrokeOnly, _user$project$Model$Gradient]);
var _user$project$Model$pieceComparer = F2(
	function (_p14, _p13) {
		var _p15 = _p14;
		var _p16 = _p13;
		var _p17 = A2(
			_elm_lang$core$Basics$compare,
			A2(_user$project$Extras$indexOfDefault, _user$project$Model$shapePossibilities, _p15._0),
			A2(_user$project$Extras$indexOfDefault, _user$project$Model$shapePossibilities, _p16._0));
		if (_p17.ctor === 'EQ') {
			var _p18 = A2(
				_elm_lang$core$Basics$compare,
				A2(_user$project$Extras$indexOfDefault, _user$project$Model$colourPossibilities, _p15._1),
				A2(_user$project$Extras$indexOfDefault, _user$project$Model$colourPossibilities, _p16._1));
			if (_p18.ctor === 'EQ') {
				return A2(
					_elm_lang$core$Basics$compare,
					A2(_user$project$Extras$indexOfDefault, _user$project$Model$patternPossibilities, _p15._2),
					A2(_user$project$Extras$indexOfDefault, _user$project$Model$patternPossibilities, _p16._2));
			} else {
				return _p18;
			}
		} else {
...
var _user$project$Model$emptyRack = _robertjlooby$elm_generic_dict$GenericDict$empty(_user$project$Model$pieceComparer);
var _user$project$Model$piecePossibilities = A2(
	_elm_lang$core$List$concatMap,
	function (shape) {
		return A2(
			_elm_lang$core$List$concatMap,
			function (colour) {
				return A2(
					_elm_lang$core$List$map,
					A2(_user$project$Model$Piece, shape, colour),
					_user$project$Model$patternPossibilities);
			},
			_user$project$Model$colourPossibilities);
	},
	_user$project$Model$shapePossibilities);
var _user$project$Model$fullRack = A2(
	_robertjlooby$elm_generic_dict$GenericDict$fromList,
	_user$project$Model$pieceComparer,
	A2(
		_elm_lang$core$List$map,
		function (piece) {
			return {
		...
		_user$project$Model$piecePossibilities));
var _user$project$Model$defaultState = {mdl: _debois$elm_mdl$Material$model, board: _user$project$Model$emptyBoard, selected: _elm_lang$core$Maybe$Nothing, rack: _user$project$Model$fullRack, turnState: _user$project$Model$SelectPiece};

var _user$project$Msg$Select = function (a) {
	return {ctor: 'Select', _0: a};
};
var _user$project$Msg$Place = F2(
	function (a, b) {
...
var _user$project$PieceView$pieceHeight = 50;
var _user$project$PieceView$pieceHeightString = _elm_lang$core$Basics$toString(_user$project$PieceView$pieceHeight);
var _user$project$PieceView$halfPieceHeight = _user$project$PieceView$pieceHeight / 2;
var _user$project$PieceView$halfPieceHeightString = _elm_lang$core$Basics$toString(_user$project$PieceView$halfPieceHeight);
var _user$project$PieceView$pieceWidth = 50;
var _user$project$PieceView$pieceWidthString = _elm_lang$core$Basics$toString(_user$project$PieceView$pieceWidth);
var _user$project$PieceView$halfPieceWidth = _user$project$PieceView$pieceWidth / 2;
var _user$project$PieceView$halfPieceWidthString = _elm_lang$core$Basics$toString(_user$project$PieceView$halfPieceWidth);
var _user$project$PieceView$spacing = 15;
var _user$project$PieceView$right = (3 * _user$project$PieceView$pieceWidth) + _user$project$PieceView$spacing;
var _user$project$PieceView$center = 2 * _user$project$PieceView$pieceWidth;
var _user$project$PieceView$left = _user$project$PieceView$pieceWidth - _user$project$PieceView$spacing;
var _user$project$PieceView$indexToPosition = function (index) {
	var y = (_elm_lang$core$Basics$toFloat((index / 3) | 0) * (_user$project$PieceView$pieceHeight + _user$project$PieceView$spacing)) + _user$project$PieceView$spacing;
	var x = function () {
		var _p0 = A2(_elm_lang$core$Basics_ops['%'], index, 3);
		switch (_p0) {
			case 0:
				return _user$project$PieceView$left;
			case 1:
				return _user$project$PieceView$center;
			default:
				return _user$project$PieceView$right;
		}
	}();
	return {ctor: '_Tuple2', _0: x, _1: y};
};
var _user$project$PieceView$selectedIndicator = function (_p1) {
	var _p2 = _p1;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Basics$toString(_p2._0 - 1.5)),
				_elm_lang$svg$Svg_Attributes$y(
				_elm_lang$core$Basics$toString(_p2._1 - 1.5)),
				_elm_lang$svg$Svg_Attributes$width(
				_elm_lang$core$Basics$toString(_user$project$PieceView$pieceWidth + 3)),
				_elm_lang$svg$Svg_Attributes$height(
				_elm_lang$core$Basics$toString(_user$project$PieceView$pieceHeight + 3)),
				_elm_lang$svg$Svg_Attributes$stroke('#FFDC00'),
				_elm_lang$svg$Svg_Attributes$strokeWidth('2')
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$PieceView$colourToGradientString = function (colour) {
	var _p3 = colour;
	switch (_p3.ctor) {
		case 'Red':
...
var _user$project$PieceView$colourToString = function (colour) {
	var _p4 = colour;
	switch (_p4.ctor) {
		case 'Red':
			return '#FF4136';
...
var _user$project$PieceView$renderPiece = F3(
	function (extraAttributes, _p6, _p5) {
		var _p7 = _p6;
		var _p13 = _p7._1;
		var _p12 = _p7._0;
		var _p8 = _p5;
		var _p11 = _p8._1;
		var pieceAtrributes = function () {
			var _p9 = _p8._2;
			switch (_p9.ctor) {
				case 'Full':
					return _elm_lang$core$Native_List.fromArray(
						[
							...
							_user$project$PieceView$colourToString(_p11))
						]);
				case 'StrokeOnly':
					return _elm_lang$core$Native_List.fromArray(
						[
				...
				default:
					return _elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$fill(
							_user$project$PieceView$colourToGradientString(_p11))
						]);
			}
		}();
		var _p10 = _p8._0;
						...
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$svg$Svg_Attributes$width(_user$project$PieceView$pieceWidthString),
									_elm_lang$svg$Svg_Attributes$height(_user$project$PieceView$pieceHeightString)
								]))),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'Circle':
						...
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Basics$toString(_p12 + _user$project$PieceView$halfPieceWidth)),
									_elm_lang$svg$Svg_Attributes$cy(
									_elm_lang$core$Basics$toString(_p13 + _user$project$PieceView$halfPieceHeight)),
									_elm_lang$svg$Svg_Attributes$rx(_user$project$PieceView$halfPieceWidthString),
									_elm_lang$svg$Svg_Attributes$ry(_user$project$PieceView$halfPieceHeightString)
								]))),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
											...
											A2(
												...
												A2(
													...
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															_elm_lang$core$Basics$toString((0 - _user$project$PieceView$pieceWidth) / 2),
															A2(
																_elm_lang$core$Basics_ops['++'],
																' ',
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	_user$project$PieceView$pieceHeightString,
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		' l ',
																		A2(_elm_lang$core$Basics_ops['++'], _user$project$PieceView$pieceWidthString, ' 0 Z')))))))))))
								]))),
					_elm_lang$core$Native_List.fromArray(
						[]));
		}
	});
var _user$project$PieceView$nullSvg = _elm_lang$svg$Svg$text('');
var _user$project$PieceView$renderPieceInRack = F5(
	function (turnState, _p14, isSelected, isPresent, piece) {
		var _p15 = _p14;
		var _p16 = _p15;
		if (isPresent) {
			var extraAttributes = _elm_lang$core$Native_Utils.eq(turnState, _user$project$Model$SelectPiece) ? _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Events$onClick(
					_user$project$Msg$Select(piece))
				]) : _elm_lang$core$Native_List.fromArray(
				[]);
			var renderedPiece = A3(_user$project$PieceView$renderPiece, extraAttributes, _p16, piece);
			return isSelected ? A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						renderedPiece,
						_user$project$PieceView$selectedIndicator(_p16)
					])) : renderedPiece;
		} else {
			return _user$project$PieceView$nullSvg;
		}
	});
var _user$project$PieceView$renderPieces = F3(
	function (turnState, selected, rack) {
		...
		return A2(
			...
			F2(
				function (index, piece) {
					return A5(
						_user$project$PieceView$renderPieceInRack,
						turnState,
						_user$project$PieceView$indexToPosition(index),
						isSelected(piece),
						A2(_user$project$Model$isInRack, piece, rack),
						piece);
				}),
			_user$project$Model$piecePossibilities);
	});
var _user$project$PieceView$rackHeight = 600;
var _user$project$PieceView$rackHeightString = _elm_lang$core$Basics$toString(_user$project$PieceView$rackHeight);
var _user$project$PieceView$rackWidth = 250;
var _user$project$PieceView$rackWidthString = _elm_lang$core$Basics$toString(_user$project$PieceView$rackWidth);
var _user$project$PieceView$renderRack = F3(
	function (turnState, selected, rack) {
		return A2(
			_elm_lang$svg$Svg$svg,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$width(_user$project$PieceView$rackWidthString),
					_elm_lang$svg$Svg_Attributes$height(_user$project$PieceView$rackHeightString),
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$PieceView$rackWidthString,
							A2(_elm_lang$core$Basics_ops['++'], ' ', _user$project$PieceView$rackHeightString))))
				]),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg_Attributes$id('RedGradient'),
										_elm_lang$svg$Svg_Attributes$x1('0'),
										_elm_lang$svg$Svg_Attributes$x2('1'),
										_elm_lang$svg$Svg_Attributes$y1('0'),
										_elm_lang$svg$Svg_Attributes$y2('1')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$svg$Svg_Attributes$offset('12.5%'),
												_elm_lang$svg$Svg_Attributes$stopColor(
												_user$project$PieceView$colourToString(_user$project$Model$Red))
											]),
										_elm_lang$core$Native_List.fromArray(
											[])),
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$svg$Svg_Attributes$offset('87.5%'),
												_elm_lang$svg$Svg_Attributes$stopColor(
												_user$project$PieceView$colourToString(_user$project$Model$Red)),
												_elm_lang$svg$Svg_Attributes$stopOpacity('0')
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									])),
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg_Attributes$id('GreenGradient'),
										_elm_lang$svg$Svg_Attributes$x1('0'),
										_elm_lang$svg$Svg_Attributes$x2('1'),
										_elm_lang$svg$Svg_Attributes$y1('0'),
										_elm_lang$svg$Svg_Attributes$y2('1')
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$svg$Svg_Attributes$offset('12.5%'),
												_elm_lang$svg$Svg_Attributes$stopColor(
												_user$project$PieceView$colourToString(_user$project$Model$Green))
											]),
										_elm_lang$core$Native_List.fromArray(
											[])),
										A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$svg$Svg_Attributes$id('BlueGradient'),
										_elm_lang$svg$Svg_Attributes$x1('0'),
										_elm_lang$svg$Svg_Attributes$x2('1'),
										_elm_lang$svg$Svg_Attributes$y1('0'),
										_elm_lang$svg$Svg_Attributes$y2('1')
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$svg$Svg_Attributes$offset('12.5%'),
												_elm_lang$svg$Svg_Attributes$stopColor(
												_user$project$PieceView$colourToString(_user$project$Model$Blue))
											]),
										_elm_lang$core$Native_List.fromArray(
											[])),
										A2(
				...
				A3(_user$project$PieceView$renderPieces, turnState, selected, rack)));
	});

var _user$project$View$strokeSpacing = 0.125;
var _user$project$View$spaceScale = 80;
var _user$project$View$spaceScaleString = _elm_lang$core$Basics$toString(_user$project$View$spaceScale);
var _user$project$View$minusSpaceScaleString = _elm_lang$core$Basics$toString(0 - _user$project$View$spaceScale);
var _user$project$View$halfSpaceScale = _user$project$View$spaceScale / 2;
var _user$project$View$halfSpaceScaleString = _elm_lang$core$Basics$toString(_user$project$View$halfSpaceScale);
var _user$project$View$minusHalfSpaceScaleString = _elm_lang$core$Basics$toString(0 - _user$project$View$halfSpaceScale);
var _user$project$View$scpaceWidth = _user$project$View$spaceScale * (2 + _user$project$View$strokeSpacing);
var _user$project$View$shortCornerHeight = (_user$project$View$spaceScale * 3) / 8;
var _user$project$View$spaceHeight = _user$project$View$shortCornerHeight * (2 + _user$project$View$strokeSpacing);
var _user$project$View$shortCornerString = _elm_lang$core$Basics$toString(_user$project$View$shortCornerHeight);
var _user$project$View$minusShortCornerString = _elm_lang$core$Basics$toString(0 - _user$project$View$shortCornerHeight);
var _user$project$View$spaceSuffix = A2(
	_elm_lang$core$Basics_ops['++'],
	A2(_elm_lang$core$Basics_ops['++'], ' m 0 ', _user$project$View$spaceScaleString),
	A2(
		_elm_lang$core$Basics_ops['++'],
		A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$View$spaceScaleString,
				A2(_elm_lang$core$Basics_ops['++'], ' ', _user$project$View$minusShortCornerString))),
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$Basics_ops['++'],
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$View$minusSpaceScaleString,
					A2(_elm_lang$core$Basics_ops['++'], ' ', _user$project$View$minusShortCornerString))),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$View$minusSpaceScaleString,
						A2(_elm_lang$core$Basics_ops['++'], ' ', _user$project$View$shortCornerString))),
				'Z'))));
var _user$project$View$nullSvg = _elm_lang$svg$Svg$text('');
var _user$project$View$space = F4(
	function (_p0, floorId, spaceId, space) {
		var _p1 = _p0;
		var _p5 = _p1._1;
		var _p4 = _p1._0;
		var _p2 = function () {
			var _p3 = space;
			if (_p3.ctor === 'EmptySpace') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$svg$Svg_Events$onClick(
							A2(_user$project$Msg$Place, floorId, spaceId))
						]),
					_1: _user$project$View$nullSvg
				};
			} else {
				return {
					ctor: '_Tuple2',
					...
					_1: A3(
						_user$project$PieceView$renderPiece,
						_elm_lang$core$Native_List.fromArray(
							[]),
						{ctor: '_Tuple2', _0: _p4 - (_user$project$PieceView$pieceWidth / 2), _1: _p5 + (_user$project$PieceView$pieceHeight / 2)},
						_p3._0)
				};
			}
		}();
		var msgAttributes = _p2._0;
		var pieceSvg = _p2._1;
		var dString = A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
...
var _user$project$View$renderFloor = F3(
	function (_p6, floorId, floor) {
		var _p7 = _p6;
		var _p9 = _p7._1;
		var _p8 = _p7._0;
		return _elm_lang$core$Native_List.fromArray(
			[
				...
				{ctor: '_Tuple2', _0: _p8, _1: _p9 - _user$project$View$spaceHeight},
				floorId,
				_user$project$Model$ZeroZero,
				floor.zeroZero),
				A4(
				_user$project$View$space,
				{ctor: '_Tuple2', _0: _p8 + (_user$project$View$scpaceWidth / 2), _1: _p9 - (_user$project$View$spaceHeight / 2)},
				floorId,
				_user$project$Model$OneZero,
				floor.oneZero),
				A4(
				_user$project$View$space,
				{ctor: '_Tuple2', _0: _p8 + _user$project$View$scpaceWidth, _1: _p9},
				floorId,
	...
	function (selected, board) {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A3(
					_user$project$View$renderFloor,
					{ctor: '_Tuple2', _0: _user$project$View$centerX, _1: _user$project$View$centerY - (4 * _user$project$View$spaceHeight)},
					_user$project$Model$Top,
					board.top),
				A2(
					_elm_lang$core$Basics_ops['++'],
					A3(
						_user$project$View$renderFloor,
						{ctor: '_Tuple2', _0: _user$project$View$centerX, _1: _user$project$View$centerY - (0.5 * _user$project$View$spaceHeight)},
						_user$project$Model$Middle,
						board.middle),
					A3(
						_user$project$View$renderFloor,
						{ctor: '_Tuple2', _0: _user$project$View$centerX, _1: _user$project$View$centerY + (3 * _user$project$View$spaceHeight)},
						_user$project$Model$Bottom,
						board.bottom))));
	});
var _user$project$View$turnStateToString = function (turnState) {
	var _p10 = turnState;
	switch (_p10.ctor) {
		case 'SelectPiece':
			return 'Select a piece for the CPU player to play';
		case 'PlayPiece':
			return 'Play the piece the CPU has selected for you';
		case 'Win':
			return 'You won!';
		default:
			return 'You lost!';
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A3(_user$project$PieceView$renderRack, model.turnState, model.selected, model.rack)
							])),
						A2(
						_debois$elm_mdl$Material_Grid$cell,
						_elm_lang$core$Native_List.fromArray(
							...
							[
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_1: A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(_user$project$View$boardWidth / 32),
													'px')
											}
											]))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_user$project$View$turnStateToString(model.turnState))
									])),
								A2(
								_elm_lang$svg$Svg$svg,
								_elm_lang$core$Native_List.fromArray(
...
var _user$project$Update$checkLine = F3(
	function (space1, space2, space3) {
		var _p0 = {ctor: '_Tuple3', _0: space1, _1: space2, _2: space3};
		if ((((_p0.ctor === '_Tuple3') && (_p0._0.ctor === 'OccupiedSpace')) && (_p0._1.ctor === 'OccupiedSpace')) && (_p0._2.ctor === 'OccupiedSpace')) {
			return A3(_user$project$Model$checkPiecesMatch, _p0._0._0, _p0._1._0, _p0._2._0);
		} else {
			return false;
		}
	});
var _user$project$Update$andCheckLine = F4(
	function (space1, space2, space3, previousResult) {
		return previousResult ? previousResult : A3(_user$project$Update$checkLine, space1, space2, space3);
	});
var _user$project$Update$checkThreeByThree = F9(
	function (space1, space2, space3, space4, space5, space6, space7, space8, space9) {
		return A4(
			_user$project$Update$andCheckLine,
			space3,
			space5,
			space7,
			A4(
						...
						A4(
							...
							A4(
								...
								A4(
									...
									space5,
									space6,
									A3(_user$project$Update$checkLine, space1, space2, space3))))))));
	});
var _user$project$Update$andCheckThreeByThree = function (space1) {
	return function (space2) {
		return function (space3) {
			return function (space4) {
				return function (space5) {
					return function (space6) {
						return function (space7) {
							return function (space8) {
								return function (space9) {
									return function (previousResult) {
										return previousResult ? previousResult : A9(_user$project$Update$checkThreeByThree, space1, space2, space3, space4, space5, space6, space7, space8, space9);
									};
								};
							};
						};
...
var _user$project$Update$checkFloor = F2(
	function (floorId, board) {
		var floor = A2(_user$project$Model$getFloor, floorId, board);
		return A9(_user$project$Update$checkThreeByThree, floor.zeroZero, floor.oneZero, floor.twoZero, floor.zeroOne, floor.oneOne, floor.twoOne, floor.zeroTwo, floor.oneTwo, floor.twoTwo);
	});
var _user$project$Update$andCheckFloor = F3(
	function (floorId, board, previousResult) {
		return previousResult ? previousResult : A2(_user$project$Update$checkFloor, floorId, board);
	});
var _user$project$Update$checkMultiFloorLines = function (board) {
	var bottomFloor = A2(_user$project$Model$getFloor, _user$project$Model$Bottom, board);
	var middleFloor = A2(_user$project$Model$getFloor, _user$project$Model$Middle, board);
	var topFloor = A2(_user$project$Model$getFloor, _user$project$Model$Top, board);
	return _user$project$Update$andCheckThreeByThree(topFloor.twoZero)(topFloor.twoOne)(topFloor.twoTwo)(middleFloor.oneZero)(middleFloor.oneOne)(middleFloor.oneTwo)(bottomFloor.zeroZero)(bottomFloor.zeroOne)(bottomFloor.zeroTwo)(
		_user$project$Update$andCheckThreeByThree(topFloor.zeroTwo)(topFloor.oneTwo)(topFloor.twoTwo)(middleFloor.zeroOne)(middleFloor.oneOne)(middleFloor.twoOne)(bottomFloor.zeroZero)(bottomFloor.oneZero)(bottomFloor.twoZero)(
			_user$project$Update$andCheckThreeByThree(topFloor.zeroZero)(topFloor.zeroOne)(topFloor.zeroTwo)(middleFloor.oneZero)(middleFloor.oneOne)(middleFloor.oneTwo)(bottomFloor.twoZero)(bottomFloor.twoOne)(bottomFloor.twoTwo)(
				_user$project$Update$andCheckThreeByThree(topFloor.zeroZero)(topFloor.oneZero)(topFloor.twoZero)(middleFloor.zeroOne)(middleFloor.oneOne)(middleFloor.twoOne)(bottomFloor.zeroTwo)(bottomFloor.oneTwo)(bottomFloor.twoTwo)(
					_user$project$Update$andCheckThreeByThree(topFloor.zeroTwo)(topFloor.oneTwo)(topFloor.twoTwo)(middleFloor.zeroTwo)(middleFloor.oneTwo)(middleFloor.twoTwo)(bottomFloor.zeroTwo)(bottomFloor.oneTwo)(bottomFloor.twoTwo)(
						_user$project$Update$andCheckThreeByThree(topFloor.zeroOne)(topFloor.oneOne)(topFloor.twoOne)(middleFloor.zeroOne)(middleFloor.oneOne)(middleFloor.twoOne)(bottomFloor.zeroOne)(bottomFloor.oneOne)(bottomFloor.twoOne)(
							A9(_user$project$Update$checkThreeByThree, topFloor.zeroZero, topFloor.oneZero, topFloor.twoZero, middleFloor.zeroZero, middleFloor.oneZero, middleFloor.twoZero, bottomFloor.zeroZero, bottomFloor.oneZero, bottomFloor.twoZero)))))));
};
var _user$project$Update$checkForAnyLines = function (board) {
	return A3(
		_user$project$Update$andCheckFloor,
		_user$project$Model$Bottom,
		board,
		A3(
			_user$project$Update$andCheckFloor,
			...
			A3(
				...
				_user$project$Model$Top,
				board,
				_user$project$Update$checkMultiFloorLines(board))));
};
...
var _user$project$Update$getMoves = F2(
	function (piece, board) {
		...
		var moveList = A2(
			...
			A2(
				_elm_lang$core$List$filterMap,
				function (spaceId) {
					var _p1 = A2(_user$project$Model$getSpace, spaceId, topFloor);
					if (_p1.ctor === 'EmptySpace') {
						return _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple3', _0: _user$project$Model$Top, _1: spaceId, _2: piece});
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				},
				_user$project$Model$spaceIdPossibilities),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$filterMap,
					function (spaceId) {
						var _p2 = A2(_user$project$Model$getSpace, spaceId, middleFloor);
						if (_p2.ctor === 'EmptySpace') {
							return _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple3', _0: _user$project$Model$Middle, _1: spaceId, _2: piece});
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					},
				...
				A2(
					_elm_lang$core$List$filterMap,
					function (spaceId) {
						var _p3 = A2(_user$project$Model$getSpace, spaceId, bottomFloor);
						if (_p3.ctor === 'EmptySpace') {
							return _elm_lang$core$Maybe$Just(
								{ctor: '_Tuple3', _0: _user$project$Model$Bottom, _1: spaceId, _2: piece});
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					},
...
var _user$project$Update$applyMove = F2(
	function (board, _p4) {
		var _p5 = _p4;
		return A4(_user$project$Model$place, _p5._2, _p5._0, _p5._1, board);
	});
var _user$project$Update$winningMove = F2(
	function (board, move) {
		return _user$project$Update$checkForAnyLines(
			A2(_user$project$Update$applyMove, board, move));
	});
var _user$project$Update$nonLosingMove = F2(
	function (board, _p6) {
		var _p7 = _p6;
		var potentialBoard = A2(_user$project$Update$applyMove, board, _p7);
		var potentialFutureMoves = A2(_user$project$Update$getMoves, _p7._2, potentialBoard);
		var _p8 = A2(
			_user$project$Extras$find,
			_user$project$Update$winningMove(potentialBoard),
...
var _user$project$Update$makeCpuMove = F2(
	function (piece, board) {
		var moves = A2(_user$project$Update$getMoves, piece, board);
		return A2(
			_elm_lang$core$Maybe$map,
			_user$project$Update$applyMove(board),
			A2(
				...
				A2(
					...
					function (_p11) {
						...
						return A2(
							_user$project$Extras$find,
							_user$project$Update$nonLosingMove(board),
							moves);
					},
					A2(
						_user$project$Extras$find,
						_user$project$Update$winningMove(board),
						moves))));
	});
var _user$project$Update$cpuTurn = function (model) {
	...
	if (_p13.ctor === 'Just') {
		var _p15 = _p13._0;
		var _p14 = A2(_user$project$Update$makeCpuMove, _p15, model.board);
		if (_p14.ctor === 'Just') {
			var newModel = _elm_lang$core$Native_Utils.update(
				model,
				{
					board: _p14._0,
					rack: A2(_user$project$Model$removeFromRack, _p15, model.rack),
					selected: _elm_lang$core$Maybe$Nothing
				});
			return _user$project$Update$checkForAnyLines(newModel.board) ? _elm_lang$core$Native_Utils.update(
				newModel,
				{turnState: _user$project$Model$Loss}) : newModel;
		} else {
			return model;
		}
	} else {
...
var _user$project$Update$cpuSelectPiece = function (model) {
	var remainingPieces = A2(
		_user$project$Update$shuffle,
		_mgold$elm_random_pcg$Random_Pcg$initialSeed(42),
		_user$project$Model$getRemainingPieces(model.rack));
	return A2(
		_user$project$Extras$orElseLazy,
		function (_p16) {
			var _p17 = _p16;
			return _elm_lang$core$Basics$fst(
				A2(
					_mgold$elm_random_pcg$Random_Pcg$step,
					_mgold$elm_random_pcg$Random_Pcg$sample(remainingPieces),
					_mgold$elm_random_pcg$Random_Pcg$initialSeed(42)));
		},
		A2(
			_user$project$Extras$find,
			function (piece) {
				var moves = A2(_user$project$Update$getMoves, piece, model.board);
				var _p18 = A2(
					_user$project$Extras$find,
					_user$project$Update$winningMove(model.board),
					moves);
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p19.ctor) {
			...
			case 'Place':
				...
				if (_p20.ctor === 'Just') {
					...
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							board: A4(_user$project$Model$place, _p21, _p19._0, _p19._1, model.board),
							rack: A2(_user$project$Model$removeFromRack, _p21, model.rack),
							selected: _elm_lang$core$Maybe$Nothing
						});
					return _user$project$Update$checkForAnyLines(newModel.board) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							newModel,
							{turnState: _user$project$Model$Win}),
						_1: _elm_lang$core$Platform_Cmd$none
					} : {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							newModel,
							{turnState: _user$project$Model$SelectPiece}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'Select':
				var newModel = _user$project$Update$cpuTurn(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							selected: _elm_lang$core$Maybe$Just(_p19._0)
						}));
				if (_elm_lang$core$Native_Utils.eq(newModel.turnState, _user$project$Model$SelectPiece)) {
					var _p22 = _user$project$Update$cpuSelectPiece(newModel);
					if (_p22.ctor === 'Just') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								newModel,
								{
									turnState: _user$project$Model$PlayPiece,
			...
			default:
				return A2(_debois$elm_mdl$Material$update, _p19._0, model);
		}
	});

var _user$project$Triptych$subscriptions = _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none);
var _user$project$Triptych$init = {ctor: '_Tuple2', _0: _user$project$Model$defaultState, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Triptych$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Triptych$init, update: _user$project$Update$update, subscriptions: _user$project$Triptych$subscriptions, view: _user$project$View$view})
};

var Elm = {};
Elm['Triptych'] = Elm['Triptych'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Triptych'], 'Triptych', typeof _user$project$Triptych$main === 'undefined' ? null : _user$project$Triptych$main);
